...
# Para criar uma classe abstrata deve herdar de ABCs
# E tbm deve ter metodos abstratos, pelo menos 1
class Log(ABC):
    # Tornar um metodo em abstrato
    @abstractmethod
    def _log(self, msg):...
...
class LogPrintMixin(Log):
    # Implementar metodo abstrato (DEVE SER IMPLEMENTADO)
    def _log(self, msg):
